...
// matchIfMissing=true → включён по умолчанию; явно выключается через opensearch.enabled=false
public class OpenSearchConfig {
    ...
    public OpenSearchClient openSearchClient() {
        ...
        // httpclient4 было: (host, port, scheme) — разный порядок, легко перепутать
